...
library(readxl)
coronaria <- read_excel("C:/Users/UNICA/Desktop/PRESENTACIONES DE CLASES/PRESENTACIONES EN R/IOSLIDES/REGRESION LOGISTICA/coronaria.xlsx")
attach(coronaria)
head(coronaria)
```
...
```{r}
library(readxl)
angina <- read_excel("C:/Users/UNICA/Desktop/PRESENTACIONES DE CLASES/PRESENTACIONES EN R/IOSLIDES/REGRESION LOGISTICA/angina.xlsx")
head(angina)
```
